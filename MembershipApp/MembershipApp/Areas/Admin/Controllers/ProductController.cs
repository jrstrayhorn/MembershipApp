...
namespace MembershipApp.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            // converting fetched product to a ProductModel
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title,Description,ProductLinkTextId,ProductTypeId,ImageUrl")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,Description,ProductLinkTextId,ProductTypeId,ImageUrl")] Product product)
        {
            if (ModelState.IsValid)
            {
